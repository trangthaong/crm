 ...
 */
$config['site_title']                 = !empty(get_compnay_title())?get_compnay_title():'Taskhub';       // Site Title, example.com
 ...
 */
$config['email_forgot_password'] = 'forgot-reset-password-email-template.php';
