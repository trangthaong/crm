...
class Ion_auth
{
    ...
    public function __construct()
    {
        ...
        $email_config = $this->config->item('ion_auth')['email_config'];
     ...
     * @param int|string|bool $id
     *
     * @return bool Whether the user is a member / volunteer or not.
     * @author Ben Edmunds
     */
    public function is_member($id = FALSE)
    {
        ...
        $member_group = $this->config->item('default_group', 'ion_auth');

        return $this->ion_auth_model->in_group($member_group, $id);
    }

    /**
     * @param int|string|bool $id
     *
     * @return bool Whether the user is a client or not.
     * @author Ben Edmunds
     */
