...
class Expenses extends CI_Controller
{
	...
	public function __construct()
	{
		parent::__construct();
		$this->load->database();
		$this->load->model(['workspace_model', 'expense_model', 'notifications_model', 'projects_model', 'users_model']);
	...
	public function create()
	{
		...
		$this->form_validation->set_rules('expense_type_id', str_replace(':', '', 'Expense Type is empty.'), 'trim|required|xss_clean');
		$this->form_validation->set_rules('user_id', str_replace(':', '', 'User is empty.'), 'trim|required|xss_clean');
		$this->form_validation->set_rules('amount', str_replace(':', '', 'Amount is empty.'), 'trim|required|xss_clean');
		$this->form_validation->set_rules('expense_date', str_replace(':', '', 'Expense Date is empty.'), 'trim|required|xss_clean');
	...
	public function edit()
	{
		...
		$this->form_validation->set_rules('update_title', str_replace(':', '', 'Title is empty.'), 'trim|required|xss_clean');
		$this->form_validation->set_rules('update_expense_type_id', str_replace(':', '', 'Expense Type is empty.'), 'trim|required|xss_clean');
		$this->form_validation->set_rules('update_user_id', str_replace(':', '', 'User is empty.'), 'trim|required|xss_clean');
		$this->form_validation->set_rules('update_amount', str_replace(':', '', 'Amount is empty.'), 'trim|required|xss_clean');
		$this->form_validation->set_rules('update_expense_date', str_replace(':', '', 'Expense Date is empty.'), 'trim|required|xss_clean');
	...
	public function expense_types()
	{
		if (!$this->ion_auth->logged_in()) {
			...
			if (!empty($workspace_id)) {
                ...
                $data['projects'] = $projects;
				$data['notifications'] = !empty($workspace_id) ? $this->notifications_model->get_notifications($this->session->userdata['user_id'], $workspace_id) : array();
				$this->load->view('expense-types.php', $data);
			} else {
				redirect('home', 'refresh');
			}
		}
	...
	public function get_expense_list()
	{
		if (!$this->ion_auth->logged_in()) {
			...
			$workspace_id = $this->session->userdata('workspace_id');
			return $this->expense_model->get_expense_list($workspace_id);
		}
	}
	...
	public function get_expense_type_by_id()
	{
		if (!$this->ion_auth->logged_in()) {
			...
			if (empty($id) || !is_numeric($id)) {
				redirect('expenses/expense_types', 'refresh');
				return false;
				exit(0);
			}
	...
	public function edit_expense_type()
	{
		...
		$this->form_validation->set_rules('update_title', str_replace(':', '', 'Title is empty.'), 'trim|required|xss_clean');
		$this->form_validation->set_rules('update_description', str_replace(':', '', 'description is empty.'), 'trim|required|xss_clean');
	...
	public function get_expense_type_list()
	{
		if (!$this->ion_auth->logged_in()) {
			...
			$workspace_id = $this->session->userdata('workspace_id');
			return $this->expense_model->get_expense_type_list($workspace_id);
		}
	}
