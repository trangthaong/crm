    ...
    <div id="app">
        <div class="main-wrapper main-wrapper-1">
            ...
            <div class="main-content">
                <section class="section">
                    ...
                    <div class="section-body">
                        ...
                        <?php include('search-leads-form.php'); ?>
            ...
            <div class="card mt-4">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div id="modal-title" class="d-none">Thêm khách hàng tiềm năng đơn lẻ</div>
                    ...
                    <div class="row" >
                        ...
                        <div class="form-group col-md-4">
                            <label for="mucdotiemnang">Mức độ tiềm năng</label>
                            <?= form_dropdown('mucdotiemnang', ['Cao', 'Trung bình', 'Thấp'], null, ['class' => 'form-control']) ?>
                        </div>
                    
                        <!-- Nguồn khách hàng -->
                        <div class="form-group col-md-5">
                            <label for="nguonKH">Nguồn khách hàng</label>
                            <?= form_dropdown('nguonKH', ['Tự phát triển', 'Tích hợp từ social', 'Dữ liệu đấu thầu', 'Khác'], null, ['class' => 'form-control']) ?>
                        </div>
           ...
           <?php if (check_permissions("clients", "create")) { ?>
            <div class="card mt-4">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div id="modal-title" class="d-none">Thêm khách hàng tiềm năng từ file</div>
                        <div id="modal-footer-add-title" class="d-none"><?= !empty($this->lang->line('label_add')) ? $this->lang->line('label_add') : 'Lưu'; ?></div>
                        <div class="row">
                            <div class="col-lg-7">
                            <label for="file" class="mr-3"><?= !empty($this->lang->line('label_file')) ? $this->lang->line('label_file') : 'Upload file danh sách khách hàng tiềm năng (Định dạng .csv)'; ?> <span class='text-danger text-sm'>*</span></label>
