...
<body>
    <div id="app">
        <div class="main-wrapper main-wrapper-1">
                ...
                <section class="section">
                    <div class="section-header">
                        <h1> <a href="<?= base_url('projects/details/' . $current_project['id']); ?>"><?= $current_project['title'] ?></a><?= !empty($this->lang->line('label_tasks')) ? $this->lang->line('label_tasks') : 'Tasks'; ?></h1>
                            <div class="section-header-breadcrumb">
                                <i class="btn btn-primary btn-rounded no-shadow" id="modal-add-work"><?= !empty($this->lang->line('label_create_task')) ? $this->lang->line('label_create_task') : 'Create Task'; ?></i>
                            </div>
                    </div>
                    ...
                    <div class="section-body">
                        <div class="row">
                            ...
                            <div class="modal-add-work"></div>

                            <div class="col-12">
                                <div class="board" data-plugin="dragula" data-containers="[&quot;task-list-todo&quot;,&quot;task-list-in_progress&quot;,&quot;task-list-review&quot;,&quot;task-list-done&quot;]">
                                    ...
                                    <div class="tasks animated" data-sr-id="1">
                                        ...
                                        <div id="task-list-todo" data-status="todo" class="task-list-items">
                                            ...
                                            <?php foreach ($tasks as $task) {
                                                if (($task['status'] == 'todo') && (in_array($user->id, $admin_ids) || in_array($user->id, explode(",", $task['user_id'])))
                                                ) {
                                            ...
                                            ?>
                                                    ...
                                                    <div class="card mb-0" id="<?= $task['id'] ?>">
                                                        <div class="card-body p-3">
                                                            ...
                                                            <div>
                                                                <a href="#" data-id="<?= $task['id'] ?>" class="text-body modal-add-work-ajax"><?= $task['title'] ?></a>
                                                            </div>
                                    ...
                                    <div class="tasks animated" data-sr-id="2">
                                        ...
                                        <div id="task-list-in_progress" data-status="inprogress" class="task-list-items">
                                            ...
                                            <?php foreach ($tasks as $task) {
                                                if (($task['status'] == 'inprogress') && (in_array($user->id, $admin_ids) || in_array($user->id, explode(",", $task['user_id'])))) {
                                            ?>
                                    ...
                                    <div class="tasks animated" data-sr-id="3">
                                        ...
                                        <div id="task-list-review" data-status="review" class="task-list-items">
                                            ...
                                            <?php foreach ($tasks as $task) {
                                                if (($task['status'] == 'review') && (in_array($user->id, $admin_ids) || in_array($user->id, explode(",", $task['user_id'])))) {
                                            ?>
                                    ...
                                    <div class="tasks animated" data-sr-id="4">
                                        ...
                                        <div id="task-list-done" data-status="done" class="task-list-items">
                                            ...
                                            <?php foreach ($tasks as $task) {
                                                if (($task['status'] == 'done') && (in_array($user->id, $admin_ids) || in_array($user->id, explode(",", $task['user_id'])))) {
                                            ?>
            ...
            <form action="<?= base_url('projects/create_task/' . $current_project['id']); ?>" method="post" class="modal-part" id="modal-add-work-part">
                <div class="row">
                    <div class="col-md-6">
            ...
            <form action="<?= base_url('projects/add_task_details'); ?>" enctype="multipart/form-data" class="modal-part" id="modal-add-work-part">
