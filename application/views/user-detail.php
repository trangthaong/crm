                  ...
                  <div class="profile-widget-description pb-0">
                    ...
                    <div class="col-md-8 d-flex justify-content-between p-5">
                      <table class="profile-table w-75">
                        <tr>
                          <td class="font-weight-600"><?= !empty($this->lang->line('label_name')) ? $this->lang->line('label_name') : 'Name'; ?>:</td>
                          <td class="text-muted d-inline font-weight-normal"><?= $user_detail->first_name ?> <?= $user_detail->last_name ?></td>
                        </tr>
                        <tr>
                          <td class="font-weight-600"><?= !empty($this->lang->line('label_user_type')) ? $this->lang->line('label_user_type') : 'User Type'; ?>:</td>
                          <td class="text-muted d-inline font-weight-normal">
                            <?php
                        ...
                        <tr>
                          <td class="font-weight-600"><?= !empty($this->lang->line('label_contact')) ? $this->lang->line('label_contact') : 'Contact'; ?>:</td>
                          <td class="text-muted d-inline font-weight-normal"><?= $user_detail->email ?></td>
                        </tr>

                        <tr>
                          <td class="font-weight-600"><?= !empty($this->lang->line('label_status')) ? $this->lang->line('label_status') : 'Status'; ?>:</td>
                          <td class="text-muted d-inline font-weight-normal">
                      ...
                      <table class="profile-table w-75">
                        <?php if (is_client($user_detail->id)) { ?>
                          <tr>
                            <td class="font-weight-600"><?= !empty($this->lang->line('label_company')) ? $this->lang->line('label_company') : 'Company'; ?>:</td>
                            <td class="text-muted d-inline font-weight-normal"><?= $user_detail->company ?></td>
                          </tr>
                          <tr>
                            <td class="font-weight-600"><?= !empty($this->lang->line('label_phone')) ? $this->lang->line('label_phone') : 'Phone'; ?>:</td>
                            <td class="text-muted d-inline font-weight-normal"><?= $user_detail->phone ?></td>
                          </tr>
                        <?php } ?>
                        <tr>
                          <td class="font-weight-600"><?= !empty($this->lang->line('label_date_of_birth')) ? $this->lang->line('label_date_of_birth') : 'Date of birth'; ?>:</td>
                          <td class="text-muted d-inline font-weight-normal"><?php echo date("d-M-Y", strtotime((string)$user_detail->date_of_birth)); ?></td>
                        </tr>
                        <tr>
                          <td class="font-weight-600"><?= !empty($this->lang->line('label_date_of_joining')) ? $this->lang->line('label_date_of_joining') : 'Date of joining'; ?>:</td>
                          <td class="text-muted d-inline font-weight-normal"><?php echo ($user_detail->date_of_joining ? date("d-M-Y", strtotime((string)$user_detail->date_of_joining)) : ''); ?></td>
                        </tr>
                        <tr>
                          <td class="font-weight-600"><?= !empty($this->lang->line('label_designation')) ? $this->lang->line('label_designation') : 'Designation'; ?>:</td>
                          <td class="text-muted d-inline font-weight-normal"><?= $user_detail->designation ?></td>
                        </tr>
                      </table>
                    </div>
                    ...
                    <div class="card-body">
                      ...
                      <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active" id="projects" role="tabpanel" aria-labelledby="projects-tab">
                          <table class='table-striped' id='projects_list' data-toggle="table" data-url="<?= base_url('projects/get_projects_list/' . $user_detail->id . '/') ?>" data-click-to-select="true" data-side-pagination="server" data-pagination="true" data-page-list="[5, 10, 20, 50, 100, 200]" data-search="false" data-show-columns="false" data-show-refresh="false" data-trim-on-search="false" data-sort-name="id" data-sort-order="desc" data-mobile-responsive="true" data-toolbar="" data-show-export="false" data-maintain-selected="true" data-export-options='{
                        ...
                        <div class="tab-pane fade" id="tasks" role="tabpanel" aria-labelledby="tasks-tab">
                          <table class='table-striped' id='tasks_list' data-toggle="table" data-url="<?= base_url('home/get_tasks_list/' . $user_detail->id . '/') ?>" data-click-to-select="true" data-side-pagination="server" data-pagination="true" data-page-list="[5, 10, 20, 50, 100, 200]" data-search="false" data-show-columns="false" data-show-refresh="false" data-trim-on-search="false" data-sort-name="id" data-sort-order="desc" data-mobile-responsive="true" data-toolbar="" data-show-export="false" data-maintain-selected="true" data-export-options='{
                              "fileName": "tasks-list",
                              "ignoreColumn": ["state"] 
                            }' data-query-params="queryParams">
                            <thead>
                        ...
                        <div class="tab-pane fade" id="leaves" role="tabpanel" aria-labelledby="leaves-tab">
                          <table class='table-striped' id='leaves_list' data-toggle="table" data-url="<?= base_url('leaves/get_leaves_list/' . $user_detail->id . '/') ?>" data-click-to-select="true" data-side-pagination="server" data-pagination="true" data-page-list="[5, 10, 20, 50, 100, 200]" data-search="false" data-show-columns="false" data-show-refresh="false" data-trim-on-search="false" data-sort-name="id" data-sort-order="desc" data-mobile-responsive="true" data-toolbar="" data-show-export="false" data-maintain-selected="true" data-export-options='{
