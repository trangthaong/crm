...
<head>
    ...
    <title><?= !empty($this->lang->line('label_add_estimate')) ? $this->lang->line('label_add_estimate') : 'Create Estimate'; ?> &mdash; <?= get_compnay_title(); ?></title>
                            ...
                            <div class='col-md-12'>
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form action="<?= base_url('estimates/create') ?>" id="create_estimate_form">
