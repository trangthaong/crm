...
<head>
  ...
  <title><?= !empty($this->lang->line('label_workspaces')) ? $this->lang->line('label_workspaces') : 'Workspaces'; ?> &mdash; <?= get_compnay_title(); ?></title>
  <?php
...
<body>
          ...
          <div class="section-body">
            <div class="row">
              <div class='col-md-12'>
                <div class="card">
                  <div class="card-body">
                    <table class='table-striped' id='item_list' data-toggle="table" data-url="<?= base_url('workspace/get_workspace_list') ?>" data-click-to-select="true" data-side-pagination="server" data-pagination="true" data-page-list="[5, 10, 20, 50, 100, 200]" data-search="true" data-show-columns="true" data-show-refresh="true" data-trim-on-search="false" data-sort-name="id" data-sort-order="desc" data-mobile-responsive="true" data-toolbar="" data-show-export="true" data-maintain-selected="true"  data-export-options='{
              ...
              <div class='col-md-12'>
                <div class="card">
                  <div class="card-body">
                    ...
                    <table class='table-striped' id='clients_list' data-toggle="table" data-url="<?= base_url('clients/get_users_list') ?>" data-click-to-select="true" data-side-pagination="server" data-pagination="true" data-page-list="[5, 10, 20, 50, 100, 200]" data-search="true" data-show-columns="true" data-show-refresh="true" data-trim-on-search="false" data-sort-name="first_name" data-sort-order="asc" data-mobile-responsive="true" data-toolbar="" data-show-export="true" data-maintain-selected="true"  data-export-options='{
  ...
  <script src="<?= base_url('assets/js/page/components-workspace.js'); ?>"></script>
