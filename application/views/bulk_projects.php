                    ...
                    <div class="section-body">
                        ...
                        <div class="row mt-sm-4">
                            <div class='col-md-12'>
                                <div class="card">
                                    <div class="card-body">
                                        <form action="<?= base_url('projects/create_bulk_project_update') ?>" id="create_bulk_project_update">
                                            <div class="row">
                                                <div class="col-lg-7">
                                            ...
                                            <div class="row">
                                                <div class="form-group">
                                                    <a href="<?= base_url('assets/project/upload/project-bulk-upload-sample.csv') ?>" class="btn btn-info mb-3 " download="project-bulk-upload-sample.csv"><?= !empty($this->lang->line('label_bulk_upload_sample_file')) ? $this->lang->line('label_bulk_upload_sample_file') : 'Bulk Upload sample file'; ?> <i class="fas fa-download"></i></a>
                                                    <a href="<?= base_url('assets/project/upload/bulk-upload-instructions.txt') ?>" class="btn btn-primary mb-3"><?= !empty($this->lang->line('label_bulk_upload_instructions')) ? $this->lang->line('label_bulk_upload_instructions') : 'Bulk Upload Instructions'; ?> <i class="fas fa-download"></i></a>
                                                    <a href="<?= base_url('assets/project/upload/project-bulk-update-sample.csv') ?>" class="btn btn-info mb-3" download="project-bulk-update-sample.csv"><?= !empty($this->lang->line('label_bulk_update_sample_file')) ? $this->lang->line('label_bulk_update_sample_file') : 'Bulk Update sample file'; ?> <i class="fas fa-download"></i></a>
                                                    <a href="<?= base_url('assets/project/upload/bulk-update-instructions.txt') ?>" class="btn btn-primary mb-3"><?= !empty($this->lang->line('label_bulk_update_instructions')) ? $this->lang->line('label_bulk_update_instructions') : 'Bulk Update Instructions'; ?> <i class="fas fa-download"></i></a>
                                                    <a class='btn btn-info mb-3' id='data' href="<?php echo base_url('projects/bulk_project_download'); ?>"> <?= !empty($this->lang->line('label_bulk_download_data')) ? $this->lang->line('label_bulk_download_data') : 'Bulk Download Data'; ?> <i class='fa fa-download'></i></a>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
