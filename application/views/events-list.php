...
<body>
                    ...
                    <div class="section-header">
                        ...
                        <div class="section-header-breadcrumb">
                            <div class="btn-group mr-2 no-shadow">
                                <a href="<?= base_url('calendar') ?>" class="btn"><i class="fas fa-th-large"></i> <?= !empty($this->lang->line('label_grid_view')) ? $this->lang->line('label_grid_view') : 'Grid View'; ?></a>
                            </div>
                            ...
                            <div class='col-md-12'>
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="form-group col-md-3">
                                                ...
                                                <select id="type" name="type" class="form-control">
                                                    ...
                                                    <option value="upcoming"><?= !empty($this->lang->line('label_upcoming')) ? $this->lang->line('label_upcoming') : 'Upcoming'; ?></option>
                                        ...
                                        <table class='table-striped' id='events_list' data-toggle="table" data-url="<?= base_url('calendar/get_events_list') ?>" data-click-to-select="true" data-side-pagination="server" data-pagination="true" data-page-list="[5, 10, 20, 50, 100, 200]" data-search="true" data-show-columns="true" data-show-refresh="true" data-trim-on-search="false" data-sort-name="id" data-sort-order="desc" data-mobile-responsive="true" data-toolbar="" data-show-export="true" data-maintain-selected="true" data-export-options='{
    ...
    <script src="<?= base_url('assets/js/page/components-calendar.js'); ?>"></script>
</body>
