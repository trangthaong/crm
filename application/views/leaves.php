...
<head>
    ...
    <title><?= !empty($this->lang->line('label_leaves')) ? $this->lang->line('label_leaves') : 'Leaves'; ?> &mdash; <?= get_compnay_title(); ?></title>
    ...
    <div id="app">
        <div class="main-wrapper main-wrapper-1">
                ...
                <section class="section">
                    ...
                    <div class="section-header">
                        ...
                        <div class="section-header-breadcrumb">
                            <?php if (check_permissions("leave_requests", "create")) { ?>
                            ...
                            <div class='col-md-12'>
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <table class='table-striped' id='leaves_list' data-toggle="table" data-url="<?= base_url('leaves/get_leaves_list') ?>" data-click-to-select="true" data-side-pagination="server" data-pagination="true" data-page-list="[5, 10, 20, 50, 100, 200]" data-search="true" data-show-columns="true" data-show-refresh="true" data-trim-on-search="false" data-sort-name="id" data-sort-order="desc" data-mobile-responsive="true" data-toolbar="#toolbar" data-show-export="true" data-maintain-selected="true" data-export-options='{
            ...
            <form action="<?= base_url('leaves/create'); ?>" id="modal-add-leave-part" class="modal-part">
                <div id="modal-title" class="d-none"><?= !empty($this->lang->line('label_request_leave')) ? $this->lang->line('label_request_leave') : 'Create Project'; ?></div>
            ...
            <form action="<?= base_url('leaves/edit'); ?>" id="modal-edit-leave-part" class="modal-part">
                <div id="modal-edit-leave-title" class="d-none"><?= !empty($this->lang->line('label_edit_leave')) ? $this->lang->line('label_edit_leave') : 'Edit Leave'; ?></div>
