    ...
    if(chat.position == 'chat-right'){
        ...
        if(!! chat.media_files){
            $.each(chat.media_files, function (key, val) {
              ...
              if(val['file_extension'] == '.jpg' || val['file_extension'] == '.png' || val['file_extension'] == '.jpeg' || val['file_extension'] == '.webp'){
                media_files += '<span class="chat-image-view"><a href="'+base_url+'assets/chats/'+val['file_name']+'" download="'+val['original_file_name']+'" class="download-btn-styling delete-msg fas fa-download"></a><a href="' + base_url + 'assets/chats/' + val['file_name'] + '" data-lightbox="image-'+val['id']+'"><img width="150px" src="'+base_url+'assets/chats/'+val['file_name']+'" draggable="false"></a></span>';
              }else{
      ...
      if(!! chat.media_files){
          $.each(chat.media_files, function (key, val) {
            ...
            if(val['file_extension'] == '.jpg' || val['file_extension'] == '.png'  || val['file_extension'] == '.jpeg' || val['file_extension'] == '.webp'){
              ...
              media_files += '<span class="chat-image-view"><a href="'+base_url+'assets/chats/'+val['file_name']+'" download="'+val['original_file_name']+'" class="download-btn-styling download-msg fas fa-download"></a><a href="' + base_url + 'assets/chats/' + val['file_name'] + '" data-lightbox="image-'+val['id']+'"><img width="150px" src="'+base_url+'assets/chats/'+val['file_name']+'" draggable="false"></a></span>';
            }else{
              media_files += '<span class="chat-files" style="position: relative;"><a href="'+base_url+'assets/chats/'+val['file_name']+'" download="'+val['original_file_name']+'" class="download-btn-styling download-msg fas fa-download"></a><div class="chat_media_img"><i class="fas fa-file-alt text-primary"></i></div><div class="chat_media_file">'+val['original_file_name']+'</div><div class="chat_media_size">'+val['file_size']+'</div></span>';
            }
          }); 
      } 
    }
