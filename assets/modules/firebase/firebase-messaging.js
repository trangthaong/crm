    ...
    callFidChangeCallbacks(n, t),
        function broadcastFidChange(e, t) {
            const n = function getBroadcastChannel() {
                !b && "BroadcastChannel" in self && (b = new BroadcastChannel("[Firebase] FID Change"), b.onmessage = e => {
...
function getDbPromise$1() {
    return k || (k = openDB("firebase-installations-database", 1, {
        upgrade: (e, t) => {
...
function getMissingValueError$1(e) {
    return w.create("missing-app-config-values", {
        valueName: e
    })
}
...
}(), e(h, "0.6.4"), e(h, "0.6.4", "esm2017");
const I = "BDOU99-h67HcA6JeFXHbSNMu7e2yNNu3RzoMj8TM4W88jITfq7ZmPvIM1Iv-4_l2LxQcYwhqby2xGpWwzjfAnG4";
var T, S;
...
function getDbPromise() {
    return D || (D = openDB("firebase-messaging-database", 1, {
        upgrade: (e, t) => {
...
async function dbGet(e) {
    ...
    if (r) return r;
    {
        const t = await async function migrateOldDatabase(e) {
            ...
            let t = null;
            return (await openDB("fcm_token_details_db", 5, {
                ...
                })).close(), await deleteDB("fcm_token_details_db"), await deleteDB("fcm_vapid_details_db"), await deleteDB("undefined"),
        ...
        if (function isTokenValid(e, t) {
            ...
            try {
                const n = await async function requestUpdateToken(e, t) {
                    ...
                    if (!o.token) throw C.create("token-update-no-token");
                    return o.token
...
async function getToken$1(e, t) {
    ...
    if ("default" === Notification.permission && await Notification.requestPermission(), "granted" !== Notification.permission) throw C.create("permission-blocked");
    return await async function updateVapidKey(e, t) {
        ...
        if (t || e.swRegistration || await registerDefaultSw(e), t || !e.swRegistration) {
            if (!(t instanceof ServiceWorkerRegistration)) throw C.create("invalid-sw-registration");
            e.swRegistration = t
        }
...
const M = "@firebase/messaging",
    WindowMessagingFactory = e => {
        ...
        return navigator.serviceWorker.addEventListener("message", (e => async function messageEventListener(e, t) {
            const n = t.data;
            if (!n.isFirebaseMessaging) return;
            e.onMessageHandler && n.messageType === S.PUSH_RECEIVED && ("function" == typeof e.onMessageHandler ? e.onMessageHandler(externalizePayload(n)) : e.onMessageHandler.next(externalizePayload(n)));
            const r = n.data;
...
function onMessage(e, t) {
    ...
    t(new Component("messaging", WindowMessagingFactory, "PUBLIC")), t(new Component("messaging-internal", WindowMessagingInternalFactory, "PRIVATE")), e(M, "0.12.4"), e(M, "0.12.4", "esm2017")
}();
export {
    deleteToken,
